...
import (
	...
	interfaces "github.com/LucasToledoPereira/go-boilerplate/apis/game/modules/studio/interfaces"
...
func NewStudioHandler(repo interfaces.IStudioRepository, filestore gbp.IFilestoreAdapter) (handler StudioHandler) {
