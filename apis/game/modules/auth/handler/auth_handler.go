...
import (
	...
	interfaces "github.com/LucasToledoPereira/go-boilerplate/apis/game/modules/auth/interfaces"
)
...
func NewAuthHandler(repo interfaces.IAuthRepository, filestore gbp.IFilestoreAdapter) (handler AuthHandler) {
	return AuthHandler{
		repository: repo,
		filestore:  filestore,
	}
