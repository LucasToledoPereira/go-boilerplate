...
import (
	...
	interfaces "github.com/LucasToledoPereira/go-boilerplate/internal/modules/user/interfaces"
...
func NewUserHandler(repo interfaces.IUserRepository, filestore filestore.IFilestoreAdapter) (handler UserHandler) {
	return UserHandler{
		repository: repo,
		filestore:  filestore,
	}
